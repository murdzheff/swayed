...
dnf5 install -y waybar qutebrowser pavucontrol NetworkManager-tui blueman  xdg-desktop-portal-gtk xdg-desktop-portal-wlr wl-clipboard
# Use a COPR Example:
#
...
dnf5 -y install hyprland hyprlock hyprpaper hyprpicker hyprshot hypridle hyprland-contrib hyprland-plugins  hyprpolkitagent hyprpanel
